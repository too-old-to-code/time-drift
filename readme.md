...
As you can see from the example above, timeDrift is chainable. You can multiple times, and you will only be returned the final value when you chain on a `val` to the end. And still, you can continue chaining after that too.
